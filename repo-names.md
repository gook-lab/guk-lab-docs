...
| 일반명사는 피하기 | `game` · `3d-map` · `stock-analysis`는 검색도 기억도 안 됩니다 |
...
| 레포 | 라이선스 | 이유 |
|---|---|---|
| `pig-ma` | **MIT** | 이미 npm에 MIT로 배포됐습니다. 나간 버전의 MIT는 소급 철회가 안 되고, 라이브러리는 애초에 쓰라고 만든 거니까요 |
...
> raw 읽기가 전부 열려 있습니다. 보이는 것과 내려받는 것은 git에서 같은 일이라서,
> 기술이 아니라 라이선스로 막습니다.
